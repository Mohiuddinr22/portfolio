    ...
    <footer className="footer footer-horizontal footer-center bg-base-200 w-full text-base-content rounded p-10">
      <div class="px-4 py-6 w-full bg-slate-100 dark:bg-slate-700 md:flex md:items-center md:justify-between">
        ...
        <div class="flex mt-4 sm:justify-center md:mt-0 space-x-5 rtl:space-x-reverse">
          ...
          <a
            href="https://discord.gg/aPZzXGsPUe"
            class="text-gray-400 hover:text-gray-900 dark:hover:text-white"
          >
            <svg
              class="w-4 h-4"
         ...
         0 5-2.239 5-5V5c0-2.761-2.239-5-5-5zM7.12 20.452H3.56V9h3.56v11.452zM5.34 
         7.433c-1.137 0-2.06-.925-2.06-2.063a2.063 2.063 0 1 1 4.125 0c0 1.138-.924 
         2.063-2.065 2.063zM20.452 20.452h-3.56v-5.605c0-1.336-.027-3.054-1.861-3.054
         -1.864 0-2.149 1.455-2.149 2.959v5.7h-3.56V9h3.419v1.561h.049c.477-.902 
         1.637-1.857 3.372-1.857 3.604 0 4.27 2.373 4.27 5.457v6.291z"
              />
            </svg>
